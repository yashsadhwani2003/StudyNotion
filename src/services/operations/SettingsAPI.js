...
export function updateProfile(token,formData){
    return async (dispatch) => {
        ...
        try{
            ...
            ? response.data.profileDetails.image : `https://api.dicebear.com/5.x/initials/svg?seed=${response.data.profileDetails.firstName} ${response.data.profileDetails.lastName}`
